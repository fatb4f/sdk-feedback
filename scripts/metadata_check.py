...
IMPORT_NAME = "sdk_feedback"
DISTRIBUTION_NAME = "sdk-feedback"
...
def main() -> None:
    ...
    assertions = {
        ...
        and project["requires-python"] == ">=3.14"
